    ...
    <transition name="slide-up">
      <div class="menu-wrapper" :class="{'hide-box-shadow': ifSettingShow || !ifTitleAndMenuShow}" v-show="ifTitleAndMenuShow">
        <div class="icon-wrapper">
          <span class="el-icon-notebook-2 icon" @click="showSetting(3)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="el-icon-thumb icon" @click="showSetting(2)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="el-icon-brush icon" @click="showSetting(1)"></span>
        </div>
        <div class="icon-wrapper">
...
<script>
import ContentView from '@/components/reader/Content'
export default {
  components: {
    ContentView
  },
